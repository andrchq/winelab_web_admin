...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'user@winelab.ru' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Иванов Иван' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: client_1.Role, example: client_1.Role.SUPPORT }),
