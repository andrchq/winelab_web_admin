...
export declare class ShipmentsService {
    ...
    create(requestId: string, warehouseId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        warehouseId: string;
    ...
    addItem(shipmentId: string, assetId: string): Promise<{
        id: string;
        shipmentId: string;
        assetId: string;
        picked: boolean;
    ...
    updateStatus(id: string, status: ShipmentStatus, assembledBy?: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        warehouseId: string;
